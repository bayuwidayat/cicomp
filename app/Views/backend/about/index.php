...
<div class="card">
    <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($h['thumbnail'])) { ?>
                                    <img src="/assets/img/about/<?= $h['thumbnail'] ?>" style="height: 50px;" class="me-3 rounded">
                                <?php } else { ?>
                            ...
                            <td class="text-center">
                                <a href="/ladmin/about/edit/<?= $h['id_about'] ?>" class="btn btn-success btn-sm"><i class="ri-pencil-fill"></i></a>
                                <a href="javascript:void(0)" onclick="hapus('<?= $h['id_about'] ?>')" class="btn btn-danger btn-sm"><i class="ri-close-line"></i></a>
                            </td>
                        </tr>
                <?php
                    endforeach;
        ...
        <?= $pager->links('about', 'lintang_pagination') ?>
    </div>
</div>
<?= $this->endSection(); ?>
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url(); ?>ladmin/about/delete/" + id,
                    type: "POST",
                    dataType: "JSON",
