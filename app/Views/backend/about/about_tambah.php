...
<div class="card p-3">
    <div class="card-body">
        ...
        <form action="<?= base_url() ?>ladmin/about/simpan" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="nm_about" class="form-label">Nama <span class="text-danger">*</span></label>
                    <input type="text" class="form-control <?= (isset($errors['nm_about'])) ? 'is-invalid' : ''; ?>" id="nm_about" name="nm_about" value="<?= old('nm_about') ?>">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="thumbnail" class="form-label">Thumbnail <span class="text-danger">*</span> (<small class="text-muted">File: jpg, png, gif. Maksimal 512kb</small>)</label>
