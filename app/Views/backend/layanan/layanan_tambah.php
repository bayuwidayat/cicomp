...
<div class="card p-3">
    <div class="card-body">
        ...
        <form action="<?= base_url() ?>ladmin/layanan/simpan" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="nm_layanan" class="form-label">Nama <span class="text-danger">*</span></label>
                    <input type="text" class="form-control <?= (isset($errors['nm_layanan'])) ? 'is-invalid' : ''; ?>" id="nm_layanan" name="nm_layanan" value="<?= old('nm_layanan') ?>">
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <textarea class="form-control <?= (isset($errors['keterangan'])) ? 'is-invalid' : ''; ?>" id="keterangan" name="keterangan" rows="3"><?= old('keterangan') ?></textarea>
