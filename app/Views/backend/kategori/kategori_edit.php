...
<div class="card p-3">
    <div class="card-body">
        ...
        <form action="<?= base_url() ?>ladmin/kategori/update" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control <?= (isset($errors['nm_kategori'])) ? 'is-invalid' : ''; ?>" id="nm_kategori" name="nm_kategori" value="<?= $kategori->nm_kategori ?>">
