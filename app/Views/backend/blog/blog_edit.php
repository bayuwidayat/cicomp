...
<div class="card p-3">
    <div class="card-body">
        ...
        <form action="<?= base_url() ?>ladmin/blog/update" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <input type="hidden" name="id_blog" id="id_blog" value="<?= $blog->id_blog ?>">
            <input type="hidden" name="banner_l" id="banner_l" value="<?= $blog->banner ?>">
            <div class="row">
                <div class="col-md-8 mb-3">
                    <label for="judul" class="form-label">Judul <span class="text-danger">*</span></label>
                    <input type="text" class="form-control <?= (isset($errors['judul'])) ? 'is-invalid' : ''; ?>" id="judul" name="judul" value="<?= $blog->judul ?>">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <?php echo form_dropdown('kategori', $get_all_combobox_kategori, $blog->kategori_id, $kategori) ?>
            ...
            <div class="row">
                <div class="col- mb-3">
                    ...
                    <textarea <?= (isset($errors['isi_blog'])) ? 'class="is-invalid"' : ''; ?> id="isi_blog" name="isi_blog"><?= $blog->isi_blog ?></textarea>
                    <div class="invalid-feedback"><?= (isset($errors['isi_blog'])) ? $errors['isi_blog'] : ''; ?></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="banner" class="form-label">Banner (<small class="text-muted">File: jpg, png, gif. Maksimal 512kb</small>)</label>
                    ...
                    <?php if (!empty($blog->banner)) { ?>
                        <img src="/assets/img/blog/<?= $blog->banner; ?>" alt="" class="mt-2" style="max-height:100px;" id="preview_l"> <a href="javascript:void(0)" id="txt_hapus_l" class="text-danger" onclick="hapus_l(<?= $blog->id_blog ?>)"><small>Hapus (x)</small></a>
                    <?php } ?>
                    <img id="preview" style="max-height:100px; display:none;" class="img-banner mt-2" /><a href="javascript:void(0)" style="display: none;" id="txt_hapus" class="text-danger" onclick="hapus()">Hapus (x)</a>
                </div>
            </div>
            <div class="row">
                <div class="col mb-3">
...
<script>
    ...
    // fungsi hapus banner lama
    function hapus_l(id) {
        $.ajax({
            url: "<?= base_url() ?>ladmin/blog/delete_banner/" + id,
            type: "POST",
            dataType: "JSON",
