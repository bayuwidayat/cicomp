...
<div class="card">
    <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($h['avatar'])) { ?>
                                    <img src="/assets/img/tim/<?= $h['avatar'] ?>" style="height: 50px;" class="me-3 rounded">
                                <?php } else { ?>
                            ...
                            <td class="text-center">
                                <a href="/ladmin/tim/edit/<?= $h['id_tim'] ?>" class="btn btn-success btn-sm"><i class="ri-pencil-fill"></i></a>
                                <a href="javascript:void(0)" onclick="hapus('<?= $h['id_tim'] ?>')" class="btn btn-danger btn-sm"><i class="ri-close-line"></i></a>
                            </td>
                        </tr>
                <?php
                    endforeach;
        ...
        <?= $pager->links('tim', 'lintang_pagination') ?>
    </div>
</div>
<?= $this->endSection(); ?>
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url(); ?>ladmin/tim/delete/" + id,
                    type: "POST",
                    dataType: "JSON",
